...
app.layout = dbc.Container(fluid=True, children=[
    ...
    html.Div(children=[
        html.Div(children=[
            ...
            html.Br(),
            html.Label('Sigma (σx) in Dataset'),
